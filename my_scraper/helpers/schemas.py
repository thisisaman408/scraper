"""
Schemas representing the configuration of a graph or node in the MyScraper library
"""

graph_schema = {
    "name": "MyScraper Graph Configuration",
    "description": "JSON schema for representing graphs in the MyScraper library",
    "type": "object",
    "properties": {
        "nodes": {
            "type": "array",
