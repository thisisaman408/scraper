...
Get up and running with MyScraper tests in 5 minutes.

## Installation

```bash
# Clone the repository
git clone https://github.com/MyScraper/Scrapegraph-ai.git
cd Scrapegraph-ai
...
### With Coverage
```bash
uv run pytest --cov=my_scraper --cov-report=html
...
- Open an issue: [GitHub Issues](https://github.com/MyScraper/Scrapegraph-ai/issues)
- Join Discord: [MyScraper Discord](https://discord.gg/gkxQDAjfeX)
