...
from my_scraper.docloaders.chromium import ChromiumLoader
...
def test_dynamic_import_failure(monkeypatch, backend):
    ...
    monkeypatch.setattr(
        "my_scraper.docloaders.chromium.dynamic_import", fake_dynamic_import
    )
...
async def test_proxy_parsing_in_init(monkeypatch):
    ...
    monkeypatch.setattr(
        "my_scraper.docloaders.chromium.parse_or_search_proxy",
...
@patch("my_scraper.docloaders.chromium.dynamic_import")
...
async def test_ascrape_playwright_calls_apply_stealth(monkeypatch):
    ...
    monkeypatch.setattr(
        "my_scraper.docloaders.chromium.Malenia.apply_stealth", dummy_apply_stealth
    )
...
async def test_ascrape_playwright_stealth_exception_cleanup(monkeypatch):
    ...
    monkeypatch.setattr(
        "my_scraper.docloaders.chromium.Malenia.apply_stealth", fail_apply_stealth
    )
