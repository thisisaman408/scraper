...
from my_scraper.graphs import AbstractGraph, BaseGraph
from my_scraper.models import DeepSeek, OneApi
from my_scraper.nodes import FetchNode, ParseNode
...
def test_llm_missing_tokens(monkeypatch, capsys):
    ...
    from my_scraper.graphs import abstract_graph
...
class TestAbstractGraph:
    ...
    def test_set_common_params(self):
        ...
        # Create a TestGraph instance with the mock graph
        with patch(
            "my_scraper.graphs.abstract_graph.AbstractGraph._create_graph",
