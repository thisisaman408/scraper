...
from my_scraper.graphs.search_graph import SearchGraph
...
class TestSearchGraph:
    ...
    @patch("my_scraper.graphs.search_graph.BaseGraph")
    @patch("my_scraper.graphs.abstract_graph.AbstractGraph._create_llm")
    ...
    @patch("my_scraper.graphs.search_graph.SearchInternetNode")
    @patch("my_scraper.graphs.search_graph.GraphIteratorNode")
    @patch("my_scraper.graphs.search_graph.MergeAnswersNode")
    @patch("my_scraper.graphs.search_graph.BaseGraph")
    @patch("my_scraper.graphs.abstract_graph.AbstractGraph._create_llm")
