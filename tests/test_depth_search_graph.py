...
from my_scraper.graphs.abstract_graph import AbstractGraph
from my_scraper.graphs.depth_search_graph import DepthSearchGraph
...
class TestDepthSearchGraph:
    ...
    def test_depth_search_graph_initialization(self, source, expected_input_key):
        ...
        with (
            patch("my_scraper.graphs.depth_search_graph.BaseGraph"),
