...
from my_scraper.graphs.json_scraper_graph import JSONScraperGraph
...
class TestJSONScraperGraph:
    ...
    @patch("my_scraper.graphs.json_scraper_graph.FetchNode")
    @patch("my_scraper.graphs.json_scraper_graph.GenerateAnswerNode")
    ...
    def test_json_scraper_graph_with_directory(
        ...
        with patch(
            "my_scraper.graphs.json_scraper_graph.BaseGraph.execute"
        ) as mock_execute:
