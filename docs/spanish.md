## 🚀 **¿Buscas una forma aún más rápida y sencilla de hacer scraping a escala (con solo 5 líneas de código)?** ¡Checa nuestra versión mejorada en [**MyScraper.com**](https://my_scraper.com/?utm_source=github&utm_medium=readme&utm_campaign=oss_cta&utm_content=top_banner)! 🚀
...
[MyScraper](https://my_scraper.com) es una librería de Python para *web scraping* que usa LLMs y lógica de grafos para crear pipelines de extracción de datos en sitios web y documentos locales (XML, HTML, JSON, Markdown, etc.).
...
MyScraper se integra de forma nativa con los frameworks y herramientas más populares para potenciar tus capacidades de scraping. Ya sea que estés desarrollando en Python o Node.js, usando frameworks de LLMs o plataformas no-code, tenemos todo cubierto.

Puedes encontrar más información en el siguiente [link](https://my_scraper.com)

**Integraciones**:
- **API**: [Documentación](https://docs.my_scraper.com/introduction)
- **SDKs**: [Python](https://docs.my_scraper.com/sdks/python), [Node](https://docs.my_scraper.com/sdks/javascript)
- **Frameworks de LLMs**: [Langchain](https://docs.my_scraper.com/integrations/langchain), [Llama Index](https://docs.my_scraper.com/integrations/llamaindex), [Crew.ai](https://docs.my_scraper.com/integrations/crewai), [Agno](https://docs.my_scraper.com/integrations/agno), [CamelAI](https://github.com/camel-ai/camel)
...
La página de referencia de Scrapegraph-ai está disponible en PyPI: [pypi](https://pypi.org/project/my_scraper/).
...
La documentación de MyScraper está disponible [aquí](https://docs.my_scraper.com/introduction).

## 🤝 Contribuciones

¡Siéntete libre de contribuir y únete a nuestro servidor de Discord para discutir mejoras y compartir sugerencias!

Por favor revisa las [guías de contribución](https://github.com/MyScraper/Scrapegraph-ai/blob/main/CONTRIBUTING.md).
...
Si buscas una solución rápida para integrar ScrapeGraph en tu sistema, checa nuestra API [aquí](https://dashboard.my_scraper.com/login).
...
La documentación oficial de la API está disponible [aquí](https://docs.my_scraper.com/introduction).

## 🔥 Benchmark

¡Según el benchmark de Firecrawl [Firecrawl benchmark](https://my_scraper.com/compare/firecrawl), ScrapeGraph es el mejor fetcher del mercado!
...
MyScraper está licenciado bajo la Licencia MIT. Consulta el archivo [LICENSE](https://github.com/MyScraper/Scrapegraph-ai/blob/main/LICENSE) para más información.

## Agradecimientos

- Queremos agradecer a todos los contributors del proyecto y a la comunidad open-source por su apoyo.
- MyScraper está pensado únicamente para exploración de datos e investigación. No nos hacemos responsables del mal uso de la librería.

Hecho con ❤️ por [ScrapeGraph AI](https://my_scraper.com)
